...
public class bp2Behavior : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        edgePosition = mainCamera.ViewportToWorldPoint(new Vector3(0.92f, 0.5f, 1.2f));
    ...
    void Update()
    {
        ...
        if (CommonPrototypeVariables.isExperimentStarted)
        {
            ...
            {
                animationTimer = 0f;
                transform.position = mainCamera.ViewportToWorldPoint(new Vector3(0.92f, 0.5f, 1.2f));
            }
            else
            {
