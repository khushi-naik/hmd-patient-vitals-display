...
public static class HR1ExperimentSequence
{
    ...
    public static readonly Block1[] hrExperimentBlock1 =
    {
        ...
        new Block1(new int[]{120,120,120,122,123,125,129,130,131,131,131,131,131,131,131,127,126,124,123,122}), //subblock1 of block 1 end hr-vh
        new Block1(new int[]{122,122,122,122,124,125,127,128,130,133,133,133,133,130,127,126,125,123,121,120}), //subblock2 of block1 start hr-vh
        ...
        new Block1(new int[]{65,65,65,65,65,59,58,56,52,50,46,46,46,46,46,46,46,46,46,46}),                         //hr-l
        new Block1(new int[]{46,46,44,42,41,40,38,35,35,35,35,35,35,35,35,35,35,35,35,35}),                     //subblock2 of block1 end hr-vl
        new Block1(new int[]{35,35,35,34,33,32,31,30,29,29,39,43,47,50,51,53,55,56,56,56}),                     //subblock3 of block1 start hr-vl
        ...
        new Block1(new int[]{117,117,117,122,124,125,129,131,136,136,136,136,132,130,125,124,123,122,121,121}), //subblock4 of block1 start hr-vh
